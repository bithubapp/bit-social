...
var _bitSocialStache = require('./bit-social.stache.js');
var _bitSocialStache2 = _interopRequireDefault(_bitSocialStache);
require('./bit-social.less.css');
var URL_TEMPLATES = {
...
exports['default'] = _can2['default'].Component.extend({
    template: _bitSocialStache2['default'],
    tag: 'bit-social',
    viewModel: {
        define: {
            text: { type: 'string' },
